            ...
            <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse gap-2">
              {
                ...
                >
                  ...
                  <button
                  type="button"
                  className="dark:text-white  hover:bg-red-600 hover:text-white focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:hover:bg-red-700 dark:focus:ring-red-800"
                >
                  Login
                </button>
                <button
